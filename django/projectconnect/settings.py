...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'https://hci-projectconnect.herokuapp.com/'
]
...
DATABASES = {
    'default': {
        ...
        'NAME': getenv('GOOBERS_DATABASE_NAME'),
        'USER': getenv('GOOBERS_DATABASE_USER'),
        'PASSWORD': getenv('GOOBERS_DATABASE_PASSWORD'),
        'HOST': getenv('GOOBERS_DATABASE_HOST'),
...
ANYMAIL = {
    "SENDINBLUE_API_KEY": getenv('GOOBERS_ANYMAIL_KEY'),
}
